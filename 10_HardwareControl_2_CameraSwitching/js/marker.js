...
function Marker(poiData) {
    ...
    */
    ...
    // Titles of odd-numbered POIs are mirrored, even-numbered POIs aren't
    this.titleLabel = new AR.Label(poiData.title.trunc(10), 1, {
        zOrder: 1,
        translate: {
            y: 0.55
        },
        mirrored: this.poiData.id % 2 == 0,
    ...
    // Descriptions of even-numbered POIs are mirrored, odd-numbered POIs aren't
