	...
	onRecognition: function onRecognitionFn(recognized, response) {
		if (recognized) {
			...
			*/
			...
			/*
				The last line combines everything by creating an AR.ImageTrackable with the Cloudtracker, the name of the image target and the drawable that should augment the recognized image.
